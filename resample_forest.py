...
from sklearn.utils import check_random_state, as_float_array, cpu_count
...
def _partition_estimators(n_estimators, n_jobs):
    ...
    n_estimators_per_job = (n_estimators // n_jobs) * \
        np.ones(n_jobs, dtype=np.int)
